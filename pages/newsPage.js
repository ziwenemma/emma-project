            ...
            properties.map((property) => (
              ...
              >
                <div className="grid grid-cols-2 relative pt-10">
                  <img
                    className="flex w-full md:w-1/3  object-contain rounded-lg rounded-r-none pb-5/6"
                    src={property.img}
                    alt=""
                  />
                  <div className="w-full md:w-2/3 px-4 py-4 bg-white rounded-lg">
                    <div className="flex items-center m-2">
                      <h2 className="text-2xl text-gray-800 font-medium mr-auto">
                        {property.title}
                      </h2>
                    </div>
                    ...
                    <p className="flex justify-end text-sm font-light text-blue-500 mt-5">
                      {property.date}
                    </p>
                  </div>
                </div>
